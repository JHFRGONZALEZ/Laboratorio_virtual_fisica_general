...
export const AccessPage: React.FC = () => {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    if (authError) setError(authError.message);
      ...
      setMessage('Revisa tu correo institucional para continuar. Puedes solicitar otro enlace en 60 segundos.');
      setCooldown(60);
