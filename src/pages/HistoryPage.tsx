...
const labels: Record<string, string> = { mru: 'MRU', mruv: 'MRUV', 'caida-libre': 'Caída Libre', 'tiro-parabolico': 'Tiro Parabólico', pendulo: 'Péndulo Simple', newton: 'Leyes de Newton', hooke: 'Ley de Hooke', energy: 'Energía Mecánica' };
